              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Add Universal</li>
                  </ol>
                </div>
                <div class="col-sm-6">
                  <!-- Bookmark Start-->
                  ...
                  <div class="col-sm-12">
                    <div class="card">
                      ...
                      @if ($message = Session::get('message'))
                        ...
                        @endif
                        <form id="writtingform" method="post" enctype="multipart/form-data" action="/admin/writtingtest/insertwrittingtest" class="theme-form">
                          @csrf
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="cityname">Type Of Modual</label>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="u_title" name="u_title" type="text" aria-describedby="emailHelp" placeholder="Enter title">
                          </div>
                          <div class="mb-3">
