...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <form method="post" action="/admin/writtingtest/deletewrittingtest">
                              @csrf
...
<div class="page-body">
          <div class="container-fluid">
            <div class="page-header">
              <div class="row">
                <div class="col-sm-6">
                  <h3>Manage Writting-Test</h3>
                  <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="/admin/dashboard">Dashboard</a></li>
                    <li class="breadcrumb-item">Manage Universal-Test</li>
                    <li class="breadcrumb-item">View Universal-Test</li>
                  </ol>
                </div>
                <div class="col-sm-6">
                  <!-- Bookmark Start-->
                  <div class="bookmark">
                    <ul>
                    <li><a href="/admin/writtingtest/addwrittingtest" data-container="body" data-bs-toggle="popover" data-placement="top" title="" data-original-title="Tables"><i data-feather="plus"></i></a></li>
                    </ul>
                  </div>
                  <!-- Bookmark Ends-->
                </div>
                      ...
                      <table class="display" id="basic-1">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><a href="{{ URL::to('/') }}/uploads/writting/{{ $row->img }}" target="_blank"><img src="{{ URL::to('/') }}/uploads/writting/{{ $row->img }}" width="100" height="100" /></a></td>
                            <td>
                              <div class="btn-group btn-group-square" role="group" aria-label="Basic example">
                                <a href="/admin/writtingtest/updatewrittingtest/{{ $row->u_test_id }}"><button class="btn btn-success btn-sm" type="button">Edit</button></a>
                                <button data-id="{{ $row->u_test_id }}" data-image="{{ $row->img }}" data-bs-toggle="modal" data-original-title="test" data-bs-target="#exampleModal" class="btn btn-danger btn-sm btn-delete" type="button">Delete</button>
                              </div>
                            </td>
                          </tr>
                         @endforeach
