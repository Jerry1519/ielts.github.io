              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Update Writting</li>
                  </ol>
                </div>
                <div class="col-sm-6">
                  <!-- Bookmark Start-->
                  <div class="bookmark">
                    <ul>
                      <li><a href="/admin/writtingtest/viewwrittingtest" data-container="body" data-bs-toggle="popover" data-placement="top" title="" data-original-title="Tables"><i data-feather="eye"></i></a></li>
                  ...
                  <div class="col-sm-12">
                    <div class="card">
                      ...
                      @if ($message = Session::get('message'))
                        ...
                        @endif
                        <form id="writtingform" enctype="multipart/form-data" method="post" action="/admin/writtingtest/editwrittingtest" class="theme-form">
                          @csrf
                          <input type="hidden" name="updateid" value="{{ $singledata->u_test_id }}"/>
                          <input type="hidden" name="oldimage" value="{{ $singledata->img }}"/>
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="subcat">Select Type of Modual</label>
                            <select class="form-control" id="type" name="type">
                              <option value="">Please select Type of Modual</option>
                              @foreach($writtingtestdata as $row)
                                <option @if($singledata->u_test_id==$row->u_test_id) selected @endif value="{{ $row->type }}">{{ $row->type }}</option>
                              @endforeach
                            </select>
                          </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="u_title" value="{{ $singledata->u_title }}" name="u_title" type="text" placeholder="Enter Test">
                          </div>
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="exampleInputEmail1">Description</label>
                            <input class="form-control" id="description" value="{{ $singledata->description }}" name="description" type="text" placeholder="Enter Description">
                          </div>  
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="img1">Image</label>
                            <input class="form-control" id="img" name="img" type="file">
                          </div>
                          <img src="{{ URL::to('/') }}/uploads/writting/{{ $singledata->img }}" width="100"/>
                          <div class="mb-3">
                          </div>
