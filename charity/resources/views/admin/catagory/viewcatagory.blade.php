...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <form method="post" action="/admin/catagory/delete">
                              @csrf
            ...
            <div class="page-header">
              <div class="row">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="bookmark">
                    <ul>
                    <li><a href="/admin/catagory/add" data-container="body" data-bs-toggle="popover" data-placement="top" title="" data-original-title="Tables"><i data-feather="plus"></i></a></li>
                    </ul>
                  </div>
                  <!-- Bookmark Ends-->
                </div>
                      ...
                      <table class="display" id="basic-1">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>{{ $loop->index + 1 }}</td>
                            <td>{{ $row->cat_name }}</td>
                            <td><a href="{{ URL::to('/') }}/uploads/category/{{ $row->cat_image }}" target="
                            _blank"><img src="{{ URL::to('/') }}/uploads/category/{{ $row->cat_image }}" width="100"/></a></td>
                            <td>
                              <div class="btn-group btn-group-square" role="group" aria-label="Basic example">
                                <a href="/admin/catagory/update/{{ $row->cat_id }}"><button class="btn btn-success btn-sm" type="button">Edit</button></a>
                                <button data-id="{{ $row->cat_id }}" data-image="{{ $row->cat_image }}" data-bs-toggle="modal" data-original-title="test" data-bs-target="#exampleModal" class="btn btn-danger btn-sm btn-delete" type="button">Delete</button>
