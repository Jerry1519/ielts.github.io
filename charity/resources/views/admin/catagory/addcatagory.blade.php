                  ...
                  <div class="col-sm-12">
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        @endif
                        <form id="formcat" enctype="multipart/form-data" method="post" action="/admin/catagory/insert" class="theme-form">
                          @csrf
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="exampleInputEmail1">Category Name</label>
                            <input class="form-control" id="txtcatname" name="txtcatname" type="text" aria-describedby="emailHelp" placeholder="">
                          </div>
                          <div class="mb-3">
