              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Update ListeningTest</li>
                  </ol>
                </div>
                <div class="col-sm-6">
                  <!-- Bookmark Start-->
                  ...
                  <div class="col-sm-12">
                    <div class="card">
                      ...
                      @if ($message = Session::get('message'))
                        ...
                        @endif
                        <form id="listeningtestform" enctype="multipart/form-data" method="post" action="/admin/listeningtest/editlisteningtest" class="theme-form">
                        @csrf
                        <input type="hidden" name="updateid" value="{{ $singledata->l_test_id }}"/>
                        <input type="hidden" name="oldaudio" value="{{ $singledata->audio_file }}"/>
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="subcat" name="subcat">
                              ...
                              @foreach($writtingtestdata as $row)
                                <option @if($singledata->u_test_id==$row->u_test_id) selected @endif value="{{ $row->u_test_id }}">{{ $row->u_title }}</option>
                              @endforeach
                            </select>
                          </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" value="" id="audio" name="audio" type="file" aria-describedby="emailHelp">
                            <audio controls>
                            <source src="{{ URL::to('/') }}/uploads/audio/{{ $singledata->audio_file }}" type="audio/mpeg">
                            </audio>
                          </div>
                          ...
                          <div class="mb-3">
                            ...
                            <input class="form-control" value="{{ $singledata->description }}" id="desc" name="desc" type="text" aria-describedby="emailHelp">
                          </div>
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="exampleInputEmail1">Time</label>
                            <input class="form-control" value="<?php echo date('Y-m-d',strtotime($singledata->time)); ?>T<?php echo date('H:i',strtotime($singledata->time)); ?>" id="time" name="time" type="datetime-local" aria-describedby="emailHelp" placeholder="Enter Date-Time">
                          </div>
                          <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <textarea id="paragraph1" value="" class="form-control" name="paragraph1" value="" rows="4" cols="50">{{ $singledata->paragraph1 }}</textarea>
                          </div>
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="exampleInputEmail1">Paragraph 2</label>
                            <textarea id="paragraph2" value="" class="form-control" name="paragraph2" value="" rows="4" cols="50">{{ $singledata->paragraph2 }}</textarea>
                          </div>
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="exampleInputEmail1">Paragraph 3</label>
                            <textarea id="paragraph3" value="" class="form-control" name="paragraph3" value="" rows="4" cols="50">{{ $singledata->paragraph3 }}</textarea>
                          </div>
                          <div class="mb-3">
                            ...
                            <div class="mb-2 form-control col-form-label pt-0">
                                <label class="col-form-label">Select Type</label>
                                    <select name="type" class="js-example-basic-single col-sm-12 form-control">
                                        ...
                                        <option value="listening" @if($singledata->type=="listening") selected @endif>Listening</option>
                                        <option value="reading" @if($singledata->type=="reading") selected @endif>Reading</option>
                                    </select>
                            </div>
                          </div>
