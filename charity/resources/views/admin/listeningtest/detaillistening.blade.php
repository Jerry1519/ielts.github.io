                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="card">
                      ...
                      <tbody>
                        <tr>
                          <th scope="row"> AudioFile</th>
                          <td><audio controls>
                            <source src="{{ URL::to('/') }}/uploads/audio/{{ $listestdata->audio_file }}" type="audio/mpeg">
                            </audio></td>
                        </tr>
                        
                        <tr>
                          <th scope="row">Title</th>
                          <td>{{ $writingdata->u_title }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td>{{ $listestdata->time }}</td>
                        </tr>
                        <tr>
                          <th scope="row">Is-Active</th>
                          <td>{{ $listestdata->isactive }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td>{!! $listestdata->paragraph1 !!}</td>
                        </tr>
                        <tr>
                          <th scope="row">Paragraph 2</th>
                          <td>{!! $listestdata->paragraph2 !!}</td>
                        </tr>
                        <tr>
                        <th scope="row">Paragraph 3</th>
                          <td>{!! $listestdata->paragraph3 !!}</td>
                        </tr>
