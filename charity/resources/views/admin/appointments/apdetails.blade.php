              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Details Appointment</li>
                  </ol>
                </div>
                <div class="col-sm-6">
                      ...
                      @if ($message = Session::get('message'))
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            <tr>
                              <th scope="row">Phone_ no</th>
                              <td>{{ $apdata->phon_no }}</td>
                            </tr>
                            <tr>
                              <th scope="row">Date</th>
                              <td>{{ $apdata->appointment_date	 }}</td>
                            </tr>
                            <tr>
                              <th scope="row">Time</th>
                              <td>{{ $apdata->appointment_time	 }}</td>
                            </tr>
                            
                            <tr>
                              <th scope="row">Masage</th>
                              <td>{{ $apdata->massage }}</td>
                            </tr> 
                            <tr>
                            ...
                            <td><a href="/admin/appointments/changestatus/{{ $apdata->apo_id }}" ><button class="btn btn-primary btn-sm" type="submit"> Aprrove</button></a>
                            <a href="/admin/appointments/penappointmnets/view" ><button class="btn btn-danger btn-sm"  type="button">Cancle</button></td></a>
                            @else
                            <td><a href="/admin/comappointments/comappointments/view" ><button class="btn btn-danger btn-sm"  type="button">Back</button></td></a>
                            @endif
