              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Add Speaking</li>
                  </ol>
                </div>
                <div class="col-sm-6">
                  <!-- Bookmark Start-->
                  ...
                  <div class="col-sm-12">
                    <div class="card">
                      ...
                      @if ($message = Session::get('message'))
                        ...
                        @endif
                        <form id="speakform" method="post" action="/admin/speaking/insertspeaking"class="theme-form">
                          @csrf
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="subcat">Select Title(test)</label>
                          ...
                          <div class="mb-3">
                            ...
                            <input id="radioinline1" type="radio" name="radio1" checked value="Yes">
                          ...
                          <div class="mb-3">
                            ...
                            <div class="mb-2 form-control col-form-label pt-0">
                                <label class="col-form-label">Select Sections</label>
                                    <select name="section" class="js-example-basic-single col-sm-12 form-control">
                                        <option value="" selected disabled>Section</option>
                                        <option value="intro">Introductory</option>
                                        <option value="que-card">Que-Card</option>
                                        <option value="followup">Followup Question</option>
                                    </select>
                            </div>
                          </div>
