...
<link rel="icon" href="{{ URL::to('/') }}/assets/images/favicon.png" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="{{ URL::to('/') }}/assets/css/bootstrap4-toggle.min.css">
@endsection
...
<script src="{{ URL::to('/') }}/assets/js/jquery-3.5.1.min.js"></script>
    ...
    <script src="{{ URL::to('/') }}/assets/js/bootstrap4-toggle.min.js"></script>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <form method="post" action="/admin/employee/deleteemp">
                              @csrf
              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <li class="breadcrumb-item"><a href="/admin/dashboard">Dashboard</a></li>
                    ...
                    <li class="breadcrumb-item">View Employee</li>
                  </ol>
                </div>
                <div class="col-sm-6">
                  <!-- Bookmark Start-->
                    <div class="bookmark">
                        <ul>
                            <li><a href="/admin/employee/addemp" data-container="body" data-bs-toggle="popover" data-placement="top" title="" data-original-title="Tables"><i data-feather="plus"></i></a></li>
                        </ul>
                    </div>
                  <!-- Bookmark Ends-->
                </div>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><div class="form-group">
                               <input type="checkbox" onchange="window.location='/admin/employee/changestatus/{{ $row->emp_id }}';"    @if($row->isactive=="Yes") checked  @endif data-toggle="toggle" data-onstyle="primary" value="active" name="active" autocomplete="off">
                         </div></td>
                            <!-- <td>{{ $row->gender }}</td>
                            <td><a href="{{ URL::to('/') }}/uploads/employee/{{ $row->empimg }}" target = "_blank"><img src="{{ URL::to('/') }}/uploads/employee/{{ $row->empimg }}" width="100"/></a></td>
                            ...
                            <td>
                              <div class="btn-group btn-group-square" role="group" aria-label="Basic example">
                                <a href="/admin/employee/updateemp/{{ $row->emp_id }}"><button class="btn btn-success btn-sm" type="button">Edit</button></a>
                                <button data-id="{{ $row->emp_id }}" data-image="{{ $row->img }}" data-bs-toggle="modal" data-original-title="test" data-bs-target="#exampleModal" class="btn btn-danger btn-sm btn-delete" type="button">Delete</button>
                                <a href="/admin/employee/detailemp/{{ $row->emp_id }}"><button class="btn btn-secondary btn-sm" type="button">View</button></a>
                              </div>
                            </td>                      
                          </tr>
                          @endforeach
