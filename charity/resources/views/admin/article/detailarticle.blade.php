...
<div class="container-fluid">
   <div class="page-header">
      <div class="row">
         <div class="col-sm-6">
            <h3>details of Article</h3>
            <ol class="breadcrumb">
               <li class="breadcrumb-item"><a href="/admin/dashboard">Dashboard</a></li>
               <li class="breadcrumb-item">Manage Article</li>
               <li class="breadcrumb-item">detail Article</li>
            </ol>
         </div>
         <div class="col-sm-6">
            <!-- Bookmark Start-->
                     ...
                     <table class="table">
                        <tbody>
                           <tr>
                              ...
                              <td>{{ $articledata->article_title }}</td>
                           </tr>
                           <tr>
                           ...
                           <tr>
                              ...
                              <td><img src="{{ URL::to('/') }}/uploads/article/{{ $articledata->img1 }}" width="100"/></td>
                           </tr>
                           <th scope="row">Source</th>
                           <td>{{ $articledata->video_url }}</td>
                           </tr>
                           <tr>
                              <th scope="row">Refrence Link</th>
                              <td>{{ $articledata->ref_link }}</td>
                           </tr>
                           <tr>
                              <th scope="row">Post Date-Time</th>
                              <td>{{ $articledata->article_datetime }}</td>
                           </tr>
                        </tbody>
                     </table>
                  </div>
