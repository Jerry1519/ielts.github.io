                  ...
                  <div class="col-sm-12">
                    <div class="card">
                      ...
                      @if ($message = Session::get('message'))
                        ...
                        @endif
                        <form id="writtingform" enctype="multipart/form-data" method="post" action="/admin/writting/editwritting" class="theme-form">
                          @csrf
                          <input type="hidden" name="updateid" value="{{ $singledata->writting_id }}"/>
                          <input type="hidden" name="oldimage" value="{{ $singledata->image }}"/>
                          <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="name" value="{{ $singledata->topic_name }}" name="name" type="text" aria-describedby="emailHelp" placeholder="Enter Topic">
                          </div>
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="exampleInputEmail1">Time</label>
                            <input class="form-control" id="time" value="{{ $singledata->time }}" name="time" type="time" aria-describedby="emailHelp" placeholder="Enter time">
                          </div>
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="exampleInputPassword1">Type</label>
                            <div class="radio radio-primary">
                            <input id="radioinline1" type="radio" checked name="radio1" value="task1" @if($singledata->type=="task1") checked @endif>
                            <label class="mb-0" for="radioinline1">Task1</label>
                            <input id="radioinline2" type="radio" name="radio1" value="task2" @if($singledata->type=="task2") checked @endif>
                          ...
                          <img src="{{ URL::to('/') }}/uploads/writtingquestion/{{ $singledata->image }}" width="100"/>
                          <div class="mb-3">
                          </div>
