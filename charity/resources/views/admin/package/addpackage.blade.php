                  ...
                  <div class="col-sm-12">
                    <div class="card">
                      ...
                      @if ($message = Session::get('message'))
                        ...
                        @endif
                        <form id="packform" method="post" action="/admin/package/insertpackage" class="theme-form">
                          @csrf
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="pkgname">Package Name</label>
                            <input class="form-control" id="pkgname" name="pkgname" type="text" aria-describedby="emailHelp" placeholder="Enter Package Name">
                          </div>
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="pkgdesc">Package Description</label>
                            <textarea id="pkgdesc" class="form-control" name="pkgdesc" value="" rows="4" cols="50" ></textarea>
                          </div>
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="spkdesc">Speaking Description</label>
                            <textarea id="spkdesc" class="form-control" name="spkdesc" value="" rows="4" cols="50"></textarea>
                          </div>
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="lisdesc">Listening Description</label>
                            <textarea id="lisdesc" class="form-control" name="lisdesc" value="" rows="4" cols="50"></textarea>
                          </div>
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="wrtdesc">Writting Description</label>
                            <textarea id="wrtdesc" class="form-control" name="wrtdesc" value="" rows="4" cols="50"></textarea>
                          </div>
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="reddesc">Reading Description</label>
                            <textarea id="reddesc" class="form-control" name="reddesc" value="" rows="4" cols="50"></textarea>
                          </div>
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="exampleInputEmail1">Price</label>
                            <input class="form-control" id="price" name="price" type="text" aria-describedby="emailHelp" placeholder="Enter Price">
                          </div>
                          <div class="mb-3">
