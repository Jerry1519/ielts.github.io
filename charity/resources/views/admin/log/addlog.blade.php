              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Add Log</li>
                  </ol>
                </div>
                <div class="col-sm-6">
                  <!-- Bookmark Start-->
                  ...
                  <div class="col-sm-12">
                    <div class="card">
                      ...
                      @if ($message = Session::get('message'))
                        ...
                        @endif
                        <form id="logform" enctype="multipart/form-data" method="post" action="/admin/log/insertlog" class="theme-form">
                          @csrf
                          <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <input class="form-control" id="Status" name="Status" type="text" aria-describedby="Status" placeholder="Enter Status">
                          </div>
                          <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <input class="form-control" id="logdatedime" name="logdatedime" type="datetime-local" placeholder="Enter Log-DateTime">
                          </div>
