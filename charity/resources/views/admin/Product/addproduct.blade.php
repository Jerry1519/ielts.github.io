                  ...
                  <div class="col-sm-12">
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <form id="form1" enctype="multipart/form-data" method="post" action="/admin/product/insertprod"class="theme-form">
                          @csrf
                          <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <input class="form-control" id="prodname" name="prodname" type="text" aria-describedby="prodname" placeholder="Enter ProductName">
                          </div>
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="proddecs">Product Description</label>
                            <textarea id="proddecs" class="form-control" name="proddecs" rows="4" cols="50">Enter Product Description</textarea>
                          </div>
                          <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <input class="form-control" id="videourl" name="videourl" type="text">
                          </div>
                          <div class="mb-3">
