...
<!-- Mirrored from admin.pixelstrap.com/viho/theme/sign-up-two.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Nov 2021 08:47:49 GMT -->
<head>
    ...
    <!-- Plugins css start-->
    <link rel="stylesheet" type="text/css" href="{{ URL::to('/') }}/assets/css/sweetalert2.css">
    <!-- Plugins css Ends-->
    <!-- Bootstrap css-->
  ...
  <body>
    ...
    <section>         
      <div class="container-fluid p-0"> 
        <div class="row m-0">
          <div class="col-xl-7 p-0"><img class="bg-img-cover bg-center" src="{{ URL::to('/') }}/assets/images/login/1.jpg" alt="looginpage"></div>
    ...
    <!-- Plugins JS start-->
    <script src="{{ URL::to('/') }}/assets/js/sweet-alert/sweetalert.min.js"></script>
    <!-- Plugins JS Ends-->
    <!-- Theme js-->
