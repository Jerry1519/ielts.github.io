              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Add Result</li>
                  </ol>
                </div>
                <div class="col-sm-6">
                  <!-- Bookmark Start-->
                  ...
                  <div class="col-sm-12">
                    <div class="card">
                      ...
                      @if ($message = Session::get('message'))
                        ...
                        @endif
                        <form id="resultform" method="post" action="/admin/result/insertresult" class="theme-form">
                          @csrf
                          <div class="mb-3">
                            ...
                            <select class="form-control" id="ansname" name="ansname">
                              ...
                              @foreach($ansdata as $row)
                                <option value="{{ $row->answer_id }}">{{ $row->answer }}</option>
                              @endforeach
                            </select>
                          </div>
                        <div class="mb-3">
                            <label class="col-form-label pt-0" for="exampleInputEmail1">Remarks</label>
                            <input class="form-control" id="remarks" name="remarks" type="text" aria-describedby="emailHelp" placeholder="Enter Remarks">
                          </div>
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="exampleInputEmail1">Rating</label>
                            <input class="form-control" id="rating" name="rating" type="text" aria-describedby="emailHelp" placeholder="Enter Rating">
                          </div>
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="exampleInputEmail1">Added Date-Time</label>
                            <input class="form-control" id="datetime" name="datetime" type="datetime-local" aria-describedby="emailHelp" placeholder="Enter Date-Time">
                          </div>
