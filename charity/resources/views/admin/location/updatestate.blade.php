            ...
            <div class="page-header">
              <div class="row">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="bookmark">
                    <ul>
                      <li><a href="/admin/location/viewstate" data-container="body" data-bs-toggle="popover" data-placement="top" title="" data-original-title="Tables"><i data-feather="eye"></i></a></li>
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="card">
                      ...
                      @endif
                        <form id="stateForm" method="post" action="/admin/location/editstate"class="theme-form">
                          @csrf
                          <input type="hidden" name="updateid" value="{{ $singledata->state_id }}"/>
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="exampleInputEmail1">State Name</label>
                            <input value="{{ $singledata->state_name }}" class="form-control" id="statename" name="statename" type="text" aria-describedby="emailHelp" placeholder="Enter State Name">
                          </div>
