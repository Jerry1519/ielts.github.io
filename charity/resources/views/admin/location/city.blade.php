                  ...
                  <div class="col-sm-12">
                    <div class="card">
                      ...
                      @if ($message = Session::get('message'))
                        ...
                        @endif
                        <form id="cityform" method="post" action="/admin/location/insertcity"class="theme-form">
                          @csrf
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="cityname">State</label>
                            <select class="form-control" value="" id="statename" name="statename">
                          ...
                          <div class="mb-3">
                            ...
                            <input class="form-control" id="cityname" name="cityname" type="text" aria-describedby="emailHelp" placeholder="Enter City Name">
                          </div>
