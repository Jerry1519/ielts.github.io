                  ...
                  <div class="col-sm-12">
                    <div class="card">
                      ...
                      @if ($message = Session::get('message'))
                        ...
                        @endif
                        <form id="stateForm" method="post" action="/admin/location/insertstate"class="theme-form">
                          @csrf
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="exampleInputEmail1">State Name</label>
                            <input class="form-control" id="statename" name="statename" type="text" aria-describedby="emailHelp" placeholder="Enter State Name">
                          </div>
