                  ...
                  <div class="col-sm-12">
                    <div class="card">
                      ...
                      @if ($message = Session::get('message'))
                        ...
                        @endif
                        <form id="subcatform" action="/admin/subcatagory/subinsert" method="post" class="theme-form">
                          @csrf
                          <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <input class="form-control" name="txtsubcatname" id="txtsubcatname" type="text" aria-describedby="emailHelp" placeholder="Enter Subcategory Name">
                          </div>
