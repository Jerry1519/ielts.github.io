            ...
            <div class="page-header">
              <div class="row">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="bookmark">
                    <ul>
                      <li><a href="/admin/subcatagory/subview" data-container="body" data-bs-toggle="popover" data-placement="top" title="" data-original-title="Tables"><i data-feather="eye"></i></a></li>
          ...
          <div class="container-fluid">
            ...
            <div class="col-sm-12 col-xl-3"></div>
              <div class="col-sm-12 col-xl-6">
                ...
                @endif
                        <form id="subcatform" action="/admin/subcatagory/edit" method="post" class="theme-form">
                          @csrf
                          <input type="hidden" name="updateid" value="{{ $singledata->subcat_id }}"/>
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="cityname">Select Category</label>
                            <select class="form-control" id="categoryname" name="categoryname">
                              <option value="">Please Select Category</option>
                              @foreach($catdata as $row)
                                <option @if($singledata->subcat_id==$row->cat_id) selected @endif value="{{ $row->cat_id }}">{{ $row->cat_name }}</option>
                              @endforeach
                            </select>
                          </div>
                          <div class="mb-3">
                            <label class="col-form-label pt-0" for="exampleInputEmail1">Sub-Category Name</label>
                            <input class="form-control" value="{{ $singledata->subcat_name }}" name="txtsubcatname" id="txtsubcatname" type="text" aria-describedby="emailHelp" placeholder="Enter Subcategory Name">
                          </div>
