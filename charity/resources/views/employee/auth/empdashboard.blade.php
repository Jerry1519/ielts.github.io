                  ...
                  <div class="bg-primary b-r-4 card-body">
                    <div class="media static-top-widget">
                      ...
                      <div class="media-body"><span class="m-0">Test</span>
                        <h4 class="mb-0 counter">{{ count($testdata) }}</h4><i class="icon-bg" data-feather="database"></i>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="bg-secondary b-r-4 card-body">
                    <div class="media static-top-widget">
                      ...
                      <div class="media-body"><span class="m-0">Employee</span>
                        <h4 class="mb-0 counter">{{ count($empdata) }}</h4><i class="icon-bg" data-feather="shopping-bag"></i>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="bg-primary b-r-4 card-body">
                    <div class="media static-top-widget">
                      ...
                      <div class="media-body"><span class="m-0">Article</span>
                        <h4 class="mb-0 counter">{{ count($articledata) }}</h4><i class="icon-bg" data-feather="message-circle"></i>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="bg-primary b-r-4 card-body">
                    <div class="media static-top-widget">
                      ...
                      <div class="media-body"><span class="m-0">New User</span>
                        <h4 class="mb-0 counter">{{ count($userdata) }}</h4><i class="icon-bg" data-feather="user-plus"></i>
                      </div>
                    </div>
                  </div>
                </div>
