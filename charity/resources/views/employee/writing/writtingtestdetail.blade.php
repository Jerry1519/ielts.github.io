              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Manage WrittingTest</li>
                    <li class="breadcrumb-item">View WrittingTest</li>
                  </ol>
                </div>
                <div class="col-sm-6">
                  <!-- Bookmark Start-->
                  <div class="bookmark">
                    <ul>
                      <li><a href="/employee/writing/viewwritingtest/{type}" data-container="body" data-bs-toggle="popover" data-placement="top" title="" data-original-title="Tables"><i data-feather="eye"></i></a></li>
                  ...
                  <div class="col-sm-12">
                    <div class="card">
                      ...
                      @if ($message = Session::get('message'))
                        ...
                        @endif
                        <form method="post" action="/employee/storwritingdata">
                          @csrf
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $answerdata[0]->answer_text }}</td>
                                </tr>
                                <tr>
                                    <th scope="row">Answer File</th>
                                    <td>{{ $answerdata[0]->answer_file }}</td>
                                </tr>
                                <tr>
                                  <td colspan="2">
                                    <lable>Your Review</lable>
                                    <textarea name="txtans{{ $answerdata[0]->w_ans_id }}" class="form-control"></textarea>
                                    <input type="hidden" name="testid" value="{{ $id }}"/>
                                    <input type="hidden" name="type" value="{{$singledata->type }}"/>
                                    <input type="hidden" name="tans1" value="{{$answerdata[0]->w_ans_id }}"/>
                                    <input type="hidden" name="tans2" value="{{$answerdata[1]->w_ans_id }}"/>
                                  </td>
                                </tr>
                                <tr>
                                    <th scope="row">Answer</th>
                                    @if($answerdata[1]->answer_text=="")
                                    <td><a target="_blank" href="{{ $answerdata[1]->answer_file }}">View</a></td>
                                    @else
                                    <td>{{ $answerdata[1]->answer_text }}</td>
                                    @endif
                                </tr>
                                ...
                                <tr>
                                  <td colspan="2">
                                    <lable>Your Review</lable>
                                    <textarea name="txtans{{ $answerdata[1]->w_ans_id }}" class="form-control"></textarea>
                                  </td>
                                </tr>
                                <tr>
                                  <td colspan="2">
                                    <lable>Band</lable>
                                    <input type="text" name="txtband" value="{{ $singledata->band }}" class="form-control"/>
                                  </td>
                                </tr>
                            </tbody>
                        </table>
