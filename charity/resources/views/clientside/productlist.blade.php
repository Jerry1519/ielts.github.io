...
<section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="{{ URL::to('/') }}/user/images/bg/bg3.jpg">
  <div class="container pt-70 pb-20">
    ...
    <div class="section-content">
      <div class="row">
        <div class="col-md-12">
          <h2 class="title text-white">Shop</h2>
          <ol class="breadcrumb text-left text-black mt-10">
            <li><a href="/client/index">Home</a></li>
            
            <li class="active text-gray-silver">Product</li>
          </ol>
        </div>
      </div>
    </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 mb-30">
              <div class="product">
                ...
                <div class="product-thumb"> 
                  <img alt="" src="{{ URL::to('/') }}/uploads/product/{{ $row->img1 }}" class="img-responsive img-fullwidth">
                  <div class="overlay">
                    ...
                    <div class="btn-product-view-details">
                      <a class="btn btn-default btn-theme-colored btn-sm btn-flat pl-20 pr-20 btn-add-to-cart text-uppercase font-weight-700" href="/client/productdetails/{{ $row->product_id }}">View detail</a>
                    </div>
                  </div>
                </div>
                <div class="product-details text-center">
                  <a href="#"><h5 class="product-title">{{ $row->p_name }}</h5></a>
                  <div class="star-rating" title="Rated 3.50 out of 5"><span style="width: 67%;">3.50</span></div>
                  <div class="price"><del><span class="amount"><span>&#x20B9</span>110.00</span></del><ins><span class="amount"><span>&#x20B9</span>{{ $row->price }}</span></ins></div>
                </div>
              </div>
            </div>
            @endforeach
