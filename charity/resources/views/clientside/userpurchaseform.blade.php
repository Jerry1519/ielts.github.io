...
'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
    ...
    $("#checkout-form").submit(function(e){
      ...
      "prefill": {
      "contact": 'val()+"&cno="+$("#cno")',//'9904869939'
      "email":   'val()+"&email="+$("#email")'//'tutsmake@gmail.com',
      },
      "theme": {
      "color": "#528FF0"
      }
  ...
  <div class="main-content">
    ...
    <section>
      <div class="container">
        <div class="section-content">
          <div class="row mt-30">
            <form id="checkout-form" action="/client/userorder/insertuserorder" method="post" enctype="multipart/form-data">
              @csrf
              ...
              <div class="col-md-12">
                ...
                <table class="table table-striped table-bordered tbl-shopping-cart">
                  ...
                  @foreach($singledata as $row)
                    ...
                    <tr>
                    <td class="product-name"><a href="#">{{ $row->pkg_name }}</a></td>
                    <td class="product-name"><a href="#">{{ $row->pkg_des }}</a></td>
                    <td class="product-name"><a href="#">{{ $row->days }}</a></td>
                    <td class="product-subtotal" name="price"><span class="amount" ><span>&#x20B9</span>{{$row->price }}</span></td>
                    </tr>
                    @endforeach
                  </tbody>
                </table>
