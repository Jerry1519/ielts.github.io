          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <ol class="breadcrumb text-left text-black mt-10">
                <li><a href="#">Home</a></li>
                <li><a href="#">Reading Test</a></li>
                <li class="active text-gray-silver">All Reading Test</li>
              </ol>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="section-content">
          <div class="row">
              ...
              <form id="form1" action="/client/viewreadingmain/{{ $row->u_test_id }}" method="post" enctype="multipart/form-data" >
                @csrf
