   ...
   <section id="news">
      ...
      <div class="container">
        <div class="row">
         ...
         <form action="/client/insertlisteningans" method="post" enctype="multipart/form-data">
                        @csrf
            <div class="row">
               <div class="col-12">
                  <ul id="myTab" class="nav nav-tabs boot-tabs">
                     <li class="active"><a href="#main1" data-toggle="tab"><h5>Listening</h5></a></li>
