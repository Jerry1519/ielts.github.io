      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <ol class="breadcrumb text-left text-black mt-10">
            ...
            <li><a href="/client/userorder">My Order Details</a></li>
            <li class="active text-gray-silver">My Order</li>
          </ol>
        </div>
      </div>
    </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
          <div>
            ...
            <ul class="nav nav-tabs" role="tablist">
              <li role="presentation" class="active"><a href="#orders" aria-controls="orders" role="tab" data-toggle="tab" class="font-15 text-uppercase">Orders <span class="badge"></span></a></li>
                  ...
                  <table class="table table-hover">
                     ...
                     @foreach($orderdata as $row)
                        <tr>
                           ...
                           <td>{{ $row->address }}</td>
                           <td>{{ $row->amount }}</td>
                           <td><a class="btn btn-success btn-xs" href="/client/userorderdetails/{{ $row->order_id }}">View Order</a></td>
                        </tr>
                     @endforeach
                   </tbody>
                </table>
