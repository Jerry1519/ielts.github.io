    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="{{ URL::to('/') }}/user/images/bg/bg3.jpg">
      <div class="container pt-70 pb-20">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-12">
              <h2 class="title text-white">Subscribe</h2>
              <ol class="breadcrumb text-left text-black mt-10">
                <li><a href="/client/index">Home</a></li>
                <li><a href="/client/registration">Registration</a></li>
                <li class="active text-gray-silver">Otp</li>
              </ol>
            </div>
          </div>
        </div>
      ...
      <div class="container pt-30">
        <div class="row">
          <div class="col-md-6 col-md-offset-3">
            <h3>Unlimited Support &amp; Easily Customizable</h3>
            <h5>Enter OTP For Registration</h5>
            
            <!-- Mailchimp Subscription Form-->
            <form method="post"  class="newsletter-form mt-40" action="/client/checkotp">
              @csrf
              <label for="mce-EMAIL"></label>
              <div class="input-group">
                <input type="text" id="otp" name="txtotp" data-height="45px" class="form-control input-lg">
