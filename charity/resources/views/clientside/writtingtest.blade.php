          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <ol class="breadcrumb text-left text-black mt-10">
                ...
                <li class="active text-gray-silver">Writting</li>
              </ol>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="section-content">
          ...
          <div class="row">
              ...
              <form id="form1" action="/client/viewwrittingmain/{{ $row->u_test_id }}" method="post" enctype="multipart/form-data" >
            @csrf
            <div class="col-sm-6 col-md-3">              
              <article class="post clearfix mb-30 bg-lighter">
                <div class="entry-header">
                  <div class="post-thumb thumb"> 
                    <img src="{{ URL::to('/') }}/uploads/writting/{{ $row->img }}" alt="" class="img-responsive img-fullwidth"> 
                  </div>                    
                  ...
                  <div class="entry-meta media no-bg no-border mt-0 mb-10">
                    <div class="media-body pl-0">
                      <div class="event-content pull-left flip">
                        <h4 class="entry-title text-white text-uppercase font-weight-600 m-0 mt-5"><a href="#">{{ $row->u_title }}</a></h4>
                        
                      </div>
                    </div>
                  </div>
                  <p class="mt-5"><button type="button" class="btn btn-dark btn-theme-colored btn-circled btn-lg btn-start">Start</button></p>
                </div>
              </article>
            </div>
           @endforeach
